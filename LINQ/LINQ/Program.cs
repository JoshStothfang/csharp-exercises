...
Console.WriteLine($"Min is {ints.Min()} | Max is {ints.Max()} | Average is {ints.Average()}");


//method syntax
var oddSum = ints.Where(i => (i / 100) % 2 == 1).Sum();
...
//method syntax
var greaterThanAvg = ints.Where(i => i > (ints.Average()));
...
foreach (var i in greaterThanAvg)
{
    Console.Write($"{i} ");
}
